...
import es.seas.fastfoodcompany.controlador.AccionesBajaIVA;
...
/**
 * Pantalla de baja de IVAs
 *
 * @author Manuel Antonio Romero Sánchez
 */
public class PanelBajaIVA extends javax.swing.JPanel {
    private FFCFrame frame;
    private AccionesBajaIVA acciones;

    /**
     * Crea un nuevo formPanel PanelBajaIVA
     * @param frame FFCFrame Frame en el que se carga el panel
     */
    public PanelBajaIVA(FFCFrame frame) {
        initComponents();
        this.frame = frame;
        this.acciones = new AccionesBajaIVA(this);
    ...
    /**
     * Devuelve una Clase con las acciones de baja de IVAs
     *
     * @return AccionesBajaIVA Contiene las acciones de baja
     */
    public AccionesBajaIVA getAcciones() {
        return acciones;
    }

    /**
     * Establece una Clase con las acciones de baja de IVAs
     *
     * @param acciones AccionesBajaIVA Contiene las acciones de baja
     */
    public void setAcciones(AccionesBajaIVA acciones) {
    ...
    private void initComponents() {
        ...
        tablaIVA.setSelectionMode(javax.swing.ListSelectionModel.MULTIPLE_INTERVAL_SELECTION);
